...
import GbBallotPage from './pages/GbBallotPage'
...
export default function App() {
  ...
  const pages = [
    ...
    { target: '/santa', label: 'Christmas Lists', element: <GiftList2024 />, showInHeader: false, showInFooter: false },
    ...
    { target: '/group3724', label: 'Group 3-7-2024', element: <BibleReadingManualPage />, showInHeader: false, showInFooter: false },
    { target: '/poker', label: 'Poker Hand Analyzer', element: <PokerPage />, showInHeader: false, showInFooter: true },
    { target: '/pokerblinds', label: 'Poker Blinds Display', element: <BlindDisplay />, showInHeader: false, showInFooter: false, customWidth: true },
    { target: '/GingerBreadCompetition', label: 'Ginger Bread Competition', element: <GingerbreadCompetitionPage />, showInHeader: false, showInFooter: false },
